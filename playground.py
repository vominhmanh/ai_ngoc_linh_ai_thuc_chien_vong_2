#!/usr/bin/env python3
"""
Gemini API Playground - Interactive Interface
Supports: Text Chat, Image Generation, Video Generation, and Text-to-Speech
"""
...
class Config:
    def __init__(self):
        ...
        self.api_key = os.getenv("LITELLM_API_KEY", "sk-97rJFHA-3LmTPPI74ahnZw")
...
def generate_image(prompt: str, aspect_ratio: str, base_url: str, api_key: str) -> Tuple[Optional[str], str]:
...
def generate_image_chat(prompt: str, base_url: str, api_key: str) -> Tuple[Optional[str], str]:
